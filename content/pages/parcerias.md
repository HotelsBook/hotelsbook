Title: Parcerias & Contato Comercial
Description: Fale com a HotelsBook para consultoria hoteleira, demonstração do Analytics ou parcerias corporativas. Atendimento especializado para hotéis, empresas e instituições de ensino em todo o Brasil.
Slug: parcerias
Save_as: parcerias.html
Status: published

<!-- Schema Markup para SEO Local/Organization -->
...
<section class="max-w-3xl mx-auto px-4 py-16">
  <h1 class="text-3xl md:text-4xl font-bold text-navy mb-6">Fale com o Time Comercial</h1>
  <p class="text-lg text-gray-600 mb-10">Atendemos hotéis, redes hoteleiras, empresas e instituições de ensino em todo o Brasil. Selecione seu perfil para atendimento especializado e resposta em até 24 horas úteis.</p>
...
<!-- Seção opcional: Formulário futuro (comentada para implementação posterior) -->
<!--
<section class="max-w-3xl mx-auto px-4 py-12 border-t border-gray-200">
  <h2 class="text-2xl font-bold text-navy mb-6 text-center">Ou preencha nosso formulário</h2>
  <form action="https://formspree.io/f/SEU_ID_AQUI" method="POST" class="space-y-4">
    <div>
      <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nome completo</label>
      <input type="text" id="name" name="name" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lightblue focus:border-transparent">
    </div>
    <div>
      <label for="email" class="block text-sm font-medium text-gray-700 mb-1">E-mail corporativo</label>
      <input type="email" id="email" name="email" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lightblue focus:border-transparent">
    </div>
    <div>
      <label for="company" class="block text-sm font-medium text-gray-700 mb-1">Empresa / Instituição</label>
      <input type="text" id="company" name="company" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lightblue focus:border-transparent">
    </div>
    <div>
      <label for="message" class="block text-sm font-medium text-gray-700 mb-1">Como podemos ajudar?</label>
      <textarea id="message" name="message" rows="4" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-lightblue focus:border-transparent"></textarea>
    </div>
    <button type="submit" class="w-full bg-navy hover:bg-blue-900 text-white font-semibold py-3 px-6 rounded-lg transition">Enviar mensagem</button>
  </form>
</section>
-->