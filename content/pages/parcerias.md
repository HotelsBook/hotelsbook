...
Description: Canais de contato para consultoria hoteleira, demonstração do Analytics e propostas de parceria B2B.
Slug: parcerias
...
<section class="max-w-3xl mx-auto px-4 py-16">
  ...
  <p class="text-lg text-gray-600 mb-10">Atendemos hotéis, pousadas, redes regionais, empresas e instituições de ensino. Selecione seu perfil para direcionamento rápido.</p>
  ...
  <div class="bg-navy text-white p-8 rounded-xl text-center">
    <h3 class="text-xl font-bold mb-3">Agende uma conversa estratégica</h3>
    <p class="text-gray-300 mb-6">Nossa equipe retorna em até 24 horas úteis com uma proposta alinhada ao seu momento de negócio.</p>
    <a href="https://wa.me/+5585984052096" target="_blank" class="bg-lightblue hover:bg-blue-600 text-white font-medium py-3 px-6 rounded-lg transition inline-block">Iniciar pelo WhatsApp</a>
  </div>
</section>