...
<section class="bg-gray-50 py-16 px-4">
  <div class="max-w-4xl mx-auto text-center">
    <h2 class="text-3xl font-bold text-navy mb-6">Por que parceiros escolhem a HotelsBook?</h2>
    <div class="grid md:grid-cols-3 gap-8 mt-10 text-left">
      <div>
        <h4 class="font-bold text-navy mb-2">Modelo Híbrido</h4>
        <p class="text-gray-600 text-sm">Consultoria presencial complementada por plataforma SaaS. Flexibilidade para atender desde pousadas familiares até redes regionais.</p>
      </div>
      <div>
        <h4 class="font-bold text-navy mb-2">Tecnologia Proprietária</h4>
        <p class="text-gray-600 text-sm">Sem dependência de integrações frágeis. Nosso parser com IA processa relatórios de qualquer PMS ou formato exportado.</p>
      </div>
      <div>
        <h4 class="font-bold text-navy mb-2">Raiz Regional, Visão Nacional</h4>
        <p class="text-gray-600 text-sm">Nascemos no Cariri, entendemos dinâmicas locais e construímos soluções escaláveis para todo o território brasileiro.</p>
      </div>
    </div>
  </div>
</section>