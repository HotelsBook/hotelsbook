...
Description: Consultoria hoteleira, Revenue Management e agenciamento de reservas corporativas. Soluções tecnológicas para maximizar receita e profissionalizar operações no setor hoteleiro brasileiro.
Slug: index
Save_as: index.html
Status: published
  ...
  <div class="grid md:grid-cols-3 gap-8">
    <div class="p-8 border border-gray-200 rounded-xl hover:shadow-lg transition duration-300 bg-white">
      <div class="w-12 h-12 bg-lightblue/10 rounded-lg flex items-center justify-center mb-4">
        <svg class="w-6 h-6 text-lightblue" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
      </div>
...
<section class="bg-gray-50 py-16 px-4">
  <div class="max-w-4xl mx-auto text-center">
    <h2 class="text-3xl font-bold text-navy mb-6">Por que líderes hoteleiros escolhem a HotelsBook?</h2>
    <div class="grid md:grid-cols-3 gap-8 mt-10 text-left">
      <div>
        <h4 class="font-bold text-navy mb-2">Modelo Híbrido de Atuação</h4>
        <p class="text-gray-600 text-sm">Consultoria presencial complementada por plataforma SaaS. Flexibilidade para atender desde pousadas independentes até redes em expansão nacional.</p>
      </div>
      <div>
        <h4 class="font-bold text-navy mb-2">Tecnologia Proprietária</h4>
        <p class="text-gray-600 text-sm">Sem dependência de integrações frágeis. Nosso motor com IA processa relatórios de qualquer PMS ou formato exportado, garantindo agilidade na implementação.</p>
      </div>
      <div>
        <h4 class="font-bold text-navy mb-2">Escalabilidade com Governança</h4>
        <p class="text-gray-600 text-sm">Soluções desenvolvidas com arquitetura escalável, proteção de IP e foco em parcerias estratégicas de longo prazo em todo o território nacional.</p>
      </div>
    </div>
  </div>
</section>
